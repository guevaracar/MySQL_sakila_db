...
that `GROUCHO` was the correct name after all! In a single query, if the first name
 ...
 grievous error. BE CAREFUL NOT TO CHANGE THE FIRST NAME OF EVERY ACTOR TO `MUCHO GROUCHO`,
...
/*7b. Using JOINs to display all actors who appear in the film `Alone Trip`.*/
...
/*7c. You want to run an email marketing campaign in Canada, for which you
 ...
 to retrieve this information.*/ /*First one is using subqueries and second uses joins.*/
...
/*7d. Sales have been lagging among young families, and you wish to target all
 ...
 First uses subqueries and second uses joins*/
SELECT title
 FROM film 
 WHERE film_id IN
 (
